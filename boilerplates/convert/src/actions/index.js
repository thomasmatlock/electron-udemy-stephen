...
//    console.log('metadata:complete = ', videosWithData);
...
//  console.log('convertvideos = ', videos);
...
// TODO: Open the folder that the newly created video
// exists in
export const showExecutableShell = outputPath => dispatch => {
  showExecutableShell();
  ipcRenderer.send('execShell:open', outputPath);
};
